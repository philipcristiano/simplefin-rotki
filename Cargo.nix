...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "axum-embed" = rec {
        crateName = "axum-embed";
        version = "0.1.0";
        edition = "2021";
        sha256 = "0qlyxgfgk95dx527znysx8b7xsr88lq87d4hmxv8chygz2kmjy87";
        libName = "axum_embed";
        authors = [
          "Yasunobu Okamura"
        ];
      ...
      "chronoutil" = rec {
        crateName = "chronoutil";
        version = "0.2.7";
        edition = "2018";
        sha256 = "0hs53fq9v41dsnqhlpj413ykmkgiw2jyqw5j0aaxmbbwlq3qpdf9";
        authors = [
          "olliemath <oliver@suade.org>"
        ];
        dependencies = [
          {
            name = "chrono";
      ...
      "opentelemetry-http" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "internal-logs" "reqwest" "reqwest-rustls" ];
      };
      ...
      "opentelemetry_sdk" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "experimental_async_runtime" "internal-logs" "logs" "metrics" "percent-encoding" "rand" "rt-tokio" "serde_json" "tokio" "tokio-stream" "trace" ];
      };
      "ordered-float" = rec {
      ...
      "rust_decimal" = rec {
        ...
        resolvedDefaultFeatures = [ "db-postgres" "default" "serde" "serde-float" "serde-with-float" "std" ];
      };
      "rustc-hash" = rec {
      ...
      "serde-this-or-that" = rec {
        crateName = "serde-this-or-that";
        version = "0.5.0";
        edition = "2021";
        sha256 = "1gq089v5220if5cvsd4gd1g3s7b5i3pgfsrjjnhv3cjp3zk7w3pr";
        libName = "serde_this_or_that";
        authors = [
          "Ritvik Nag <me@ritviknag.com>"
        ];
        dependencies = [
          {
            name = "serde";
      ...
      "service_conventions" = rec {
        ...
        version = "0.0.32";
        edition = "2021";
        sha256 = "17mnxpck5f98d9vy7sd9q9q6yaz3b49fgnjgmqylhrpbzg71fzc6";
        dependencies = [
          {
            name = "anyhow";
            packageId = "anyhow";
        ...
        features = {
          ...
          "oidc" = [ "dep:anyhow" "dep:chrono" "dep:once_cell" "dep:openidconnect" "dep:serde" "dep:serde_json" "dep:maud" "dep:axum" "dep:tower-cookies" "dep:url" "dep:email_address" "dep:http" "dep:async-trait" "dep:axum-core" "dep:redacted" "dep:reqwest" ];
      ...
      "simplefin-rotki" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            features = [ "db-postgres" "serde-float" ];
          }
          {
            name = "serde";
            packageId = "serde";
          ...
          }
          {
            ...
            features = [ "tracing" "oidc" "tracing-http" ];
          }
          {
            name = "signal-hook";
      ...
      "tonic" = rec {
        ...
        resolvedDefaultFeatures = [ "_tls-any" "channel" "codegen" "default" "prost" "router" "server" "tls-native-roots" "tls-ring" "tls-webpki-roots" "transport" ];
      };
      "tower" = rec {
        crateName = "tower";
        version = "0.5.3";
        ...
        resolvedDefaultFeatures = [ "balance" "buffer" "discover" "futures-core" "futures-util" "indexmap" "limit" "load" "log" "make" "pin-project-lite" "ready-cache" "retry" "slab" "sync_wrapper" "timeout" "tokio" "tokio-util" "tracing" "util" ];
      };
      "tower-cookies" = rec {
      ...
      "tower-http" = rec {
        ...
        resolvedDefaultFeatures = [ "async-compression" "compression-gzip" "default" "follow-redirect" "futures-core" "futures-util" "iri-string" "tokio" "tokio-util" "tower" "trace" "tracing" ];
      };
      "tower-layer" = rec {
      ...
      "windows-sys 0.52.0" = rec {
        ...
        resolvedDefaultFeatures = [ "Win32" "Win32_Foundation" "Win32_Networking" "Win32_Networking_WinSock" "Win32_Storage" "Win32_Storage_FileSystem" "Win32_System" "Win32_System_Console" "Win32_System_Diagnostics" "Win32_System_Diagnostics_Debug" "Win32_System_IO" "Win32_System_SystemInformation" "Win32_System_Threading" "Win32_System_WindowsProgramming" "default" ];
      };
