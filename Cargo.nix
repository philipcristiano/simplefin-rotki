  ...
  internal = rec {
    ...
    crates = {
      ...
      "async-compression" = rec {
        ...
        version = "0.4.46";
        edition = "2018";
        sha256 = "0bx34304a7rir1v6nn5z2yz0pv8kfrvhb23lkap52bld1kyxl42g";
      ...
      "borsh-derive" = rec {
        ...
        version = "1.8.1";
        edition = "2018";
        sha256 = "0mlzrbwzcr7qaky1iap09m0nrzp6crjd79sinj4iz808cxjzxk8j";
        procMacro = true;
      ...
      "compression-codecs" = rec {
        ...
        version = "0.4.41";
        edition = "2018";
        sha256 = "1s0gblfcv2vfr0xxpc8f8zwkpvwcgyhgghy77dw6l0srhzdx19jq";
      ...
      "hyper-rustls" = rec {
        ...
        resolvedDefaultFeatures = [ "aws-lc-rs" "http1" "ring" "tls12" "webpki-roots" "webpki-tokio" ];
      };
      "hyper-timeout" = rec {
      ...
      "opentelemetry-otlp" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "grpc-tonic" "http" "http-proto" "internal-logs" "logs" "metrics" "opentelemetry-http" "prost" "reqwest" "reqwest-blocking-client" "reqwest-rustls-webpki-roots" "tls" "tls-aws-lc" "tls-ring" "tokio" "tonic" "tonic-types" "trace" ];
      };
      ...
      "reqwest 0.13.1" = rec {
        ...
        resolvedDefaultFeatures = [ "__rustls" "__rustls-aws-lc-rs" "__tls" "blocking" "default-tls" "json" "query" "rustls" "webpki-roots" ];
      };
      "rfc6979" = rec {
        crateName = "rfc6979";
        version = "0.4.0";
      ...
      "service_conventions" = rec {
        ...
        version = "0.0.42";
        edition = "2021";
        sha256 = "12v3zr7hb0ff6hrdi3j8g0m6ddzjz81ypdqc6p97fdhzfpvf8rsn";
        dependencies = [
          {
            name = "anyhow";
            packageId = "anyhow";
      ...
      "tower-http 0.7.1" = rec {
        ...
        resolvedDefaultFeatures = [ "compression-gzip" "default" "futures-core" "tokio-util" "trace" "tracing" ];
      };
      "tower-layer" = rec {
