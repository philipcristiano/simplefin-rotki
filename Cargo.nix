  ...
  internal = rec {
    ...
    crates = {
      ...
      "reqwest 0.13.3" = rec {
        ...
        resolvedDefaultFeatures = [ "__rustls" "__rustls-aws-lc-rs" "__tls" "json" "query" "rustls" ];
      };
      "rfc6979" = rec {
        crateName = "rfc6979";
        version = "0.4.0";
      ...
      "serde_with" = rec {
        ...
        version = "3.19.0";
        edition = "2021";
        sha256 = "06gbjdalx12grc9hx6s64ppqakn9v703ar98kfh193k1cz73jn7h";
        authors = [
          "Jonas Bushart"
          "Marcin Kaźmierczak"
        ];
      ...
      "serde_with_macros" = rec {
        ...
        version = "3.19.0";
        edition = "2021";
        sha256 = "0d53aprng783yd9wpd5rjz7crynchdb8c7l8qddv9yalc3lbnbng";
        procMacro = true;
        authors = [
          "Jonas Bushart"
        ];
